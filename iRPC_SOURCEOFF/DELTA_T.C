...
//=========  (Mon Jul 16 18:19:20 2018) by ROOT version6.06/01
   TCanvas *c1 = new TCanvas("c1", "c1",6,53,800,600);
   ...
   TPaveStats *ptstats = new TPaveStats(0.65,0.4789272,0.89,0.6283525,"blNDC");
   ...
   TText *AText = ptstats->AddText("#sigma_{HR}: 0.78 ns");
   ...
   hnew1__1__1__1->GetXaxis()->SetRangeUser(-10,10);
   hnew1__1__1__1->GetXaxis()->SetLabelFont(42);
   hnew1__1__1__1->GetXaxis()->SetLabelSize(0.05);
   hnew1__1__1__1->GetXaxis()->SetTitleSize(0.05);
   hnew1__1__1__1->GetXaxis()->SetTitleOffset(1.1);
   hnew1__1__1__1->GetXaxis()->SetTitleFont(42);
   hnew1__1__1__1->GetYaxis()->SetTitle("# hits");
   ...
   hnew1__1__1__1->GetYaxis()->SetTitleOffset(1.1);
...
tex->SetNDC();
   ...
   tex->Draw();
     ...
     tex = new TLatex(0.17,0.94,"Absolute time resolution");
     tex->SetNDC();
   tex->SetTextAlign(11);
   tex->SetTextFont(42);
   tex->SetLineWidth(2);
