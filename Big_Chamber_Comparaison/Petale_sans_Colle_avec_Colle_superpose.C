...
//=========  (Thu Feb 11 11:52:28 2016) by ROOT version5.34/30
  ...
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.1422,0.862,"Preliminary");
  tex->SetNDC();
  tex->SetTextAlign(13);
  tex->SetTextFont(52);
  ...
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.1422,0.821872,"Gas mixture : 93% TFE, 5%CO_{2}, 2%SF_{6}");
  tex->SetNDC();
  tex->SetTextAlign(13);
  tex->SetTextFont(52);
  tex->SetTextSize(0.0364);
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.1422,0.781744,"Threshold : 0.13pC");
  tex->SetNDC();
  tex->SetTextAlign(13);
  tex->SetTextFont(52);
  tex->SetTextSize(0.0364);
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.1422,0.781744-0.040128,"Cosmic #mu");
  tex->SetNDC();
  tex->SetTextAlign(13);
  tex->SetTextFont(52);
  tex->SetTextSize(0.0364);
  tex->SetLineWidth(2);
  tex->Draw();
  TPaveText* Box = new TPaveText(0.087, 0.82, 0.099, 0.90, "nbNDC");
  Box->SetFillColor(10);
  Box->SetLineColor(10);
  Box->Draw();
  Canvas_1->Modified();
