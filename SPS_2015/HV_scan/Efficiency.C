...
void myMacro()
{
  ...
  extraTexts.push_back("Gas mixture : 93% TFE, 5% CO#^{2}, 2% SF#_{6}");
  extraTexts.push_back("Threshold : 0.13pC");
  extraTexts.push_back("Intensity : 120 kHz/Spill (provided by SPS counter)");
...
{ 
  ...
  leg->AddEntry(gre, "Low Resistive Glass RPC (~10^{10}#Omega)", "p");
  leg->Draw();
