...
void SigmoidePlotter(){
  ...
  string fName = "T3S2_Efficiency_Off_220mV.root";
  ...
  TGraphAsymmErrors* Efficiency10 = (TGraphAsymmErrors*) _file1->Get("Efficiency;1");

  fName = "T3S2_Efficiency_4p6_220mV.root";
  TFile *_file2 = TFile::Open(fName.c_str());
  TGraphAsymmErrors* Efficiency4p6 = (TGraphAsymmErrors*) _file2->Get("Efficiency;1");
  ...
  leg->SetHeader("Background hits rate");
  ...
  TLatex* ltx = new TLatex(6200, 0.95,"Work in progress");
  ...
  ltx = new TLatex(8000, 0.52,"CMS gas mixture : 95.2% TFE, 4.5%CO_{2}, 0.3%SF_{6}");
  ltx->SetTextAlign(13);
  ltx->SetTextFont(52);
  ltx->SetTextSize(0.032);
  ltx->SetLineWidth(2);
