...
void StreamerPlotter(){
  ...
  string lName = "Double gap glass RPC prototype; " + xLabel + "; Streamer probability";
  ...
  TLatex* ltx = new TLatex(6000, 0.28,"Preliminary");
  ...
  ltx->SetLineWidth(2);
  ltx->Draw();
  ltx = new TLatex(6400, 0.20,"Double gap glass RPC prototype");
  ltx->SetTextAlign(13);
  ltx->SetTextFont(62);
  ltx->SetTextSize(0.032);
  ltx->SetLineWidth(2);
  ltx->Draw();
  ltx = new TLatex(6400, 0.18,"in GIF++ #mu test beams");
  ltx->SetTextAlign(13);
  ltx->SetTextFont(62);
  ltx->SetTextSize(0.032);
  ltx->SetLineWidth(2);
  ...
  ltx = new TLatex(6400, 0.16,"CMS gas mixture : 95.2% TFE, 4.5% C_{4}H_{10}, 0.3%SF_{6}");
  ltx->SetTextAlign(13);
  ltx->SetTextFont(52);
  ltx->SetTextSize(0.032);
  ltx->SetLineWidth(2);
  ltx->Draw();
  ltx = new TLatex(6400, 0.14,"Threshold #approx 0.15 pC");
  ltx->SetTextAlign(13);
  ltx->SetTextFont(52);
  ltx->SetTextSize(0.032);
  ltx->SetLineWidth(2);
  ltx->Draw();
  ltx = new TLatex(6400, 0.12,"Estimated sensitivity of 6.2 hits/1000 #gamma");
  ltx->SetTextAlign(13);
  ltx->SetTextFont(52);
  ltx->SetTextSize(0.032);
  ltx->SetLineWidth(2);
  ...
  string outName = "MultiStreamer.png"; 

  c1->SaveAs(outName.c_str());

  outName = "MultiStreamer.pdf"; 

  c1->SaveAs(outName.c_str());

  outName = "MultiStreamer.C"; 
