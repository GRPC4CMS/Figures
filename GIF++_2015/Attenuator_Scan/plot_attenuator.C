{
//=========Macro generated from canvas: FigExample_800-600_2-prelim-right/FigExample_800-600_2-prelim-right
//=========  (Tue Feb  2 10:49:38 2016) by ROOT version5.34/32
   TCanvas *FigExample_800-600_2-prelim-right = new TCanvas("FigExample_800-600_2-prelim-right", "FigExample_800-600_2-prelim-right",51,73,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   FigExample_800-600_2-prelim-right->Range(1.549911,-0.162758,6.38677,1.193558);
   FigExample_800-600_2-prelim-right->SetFillColor(0);
   FigExample_800-600_2-prelim-right->SetBorderMode(0);
   FigExample_800-600_2-prelim-right->SetBorderSize(2);
   FigExample_800-600_2-prelim-right->SetLogx();
   FigExample_800-600_2-prelim-right->SetLeftMargin(0.12);
   FigExample_800-600_2-prelim-right->SetRightMargin(0.035);
   FigExample_800-600_2-prelim-right->SetBottomMargin(0.12);
   FigExample_800-600_2-prelim-right->SetFrameFillStyle(0);
   FigExample_800-600_2-prelim-right->SetFrameBorderMode(0);
   FigExample_800-600_2-prelim-right->SetFrameFillStyle(0);
   FigExample_800-600_2-prelim-right->SetFrameBorderMode(0);
   ...
   Graph_Graph_Graph11->SetMaximum(1.07149);
   ...
   Graph_Graph_Graph11->GetXaxis()->SetTitle("Cesium Source Rate (#gamma.cm^{-2}.s^{-1})");
   ...
   Graph_Graph_Graph22->GetXaxis()->SetTitle("Cesium Source Rate ( #gamma.cm^{-2}.s^{-1})");
   ...
   FigExample_800-600_2-prelim-right->Modified();
   FigExample_800-600_2-prelim-right->cd();
   FigExample_800-600_2-prelim-right->SetSelected(FigExample_800-600_2-prelim-right);
}
