	      ...
	      {*/
	        ...
	        if(cmsText.size()==0)
	        {
	          ...
	          latex.SetTextSize(0.4*t);
	           latex.SetTextAlign(13);
	          latex.DrawLatex(posX_/*-0.75*/-0.75, posY_-extraTextSize*0.88*t*1/*-0.65*/,"CMS gas mixture : 95.2% TFE, 4.5%CO_{2}, 0.3%SF_{6}");
	           latex.SetTextAlign(13);
	          latex.DrawLatex(posX_/*-0.75*/-0.75, posY_-extraTextSize*t*0.88*2/*-0.65*/,"Threshold : 0.13pC");
	           latex.SetTextAlign(13);
	           latex.DrawLatex(posX_/*-0.75*/-0.75, posY_-extraTextSize*t*0.88*3.2/*-0.65*/,"Sensitivity to background : 3.1 hits/1000 #gamma");
	           latex.SetTextAlign(13);
